...
export default function NewProductPage() {
  ...
  const handleAddBenefit = () => {
    ...
    setBenefits([...benefits, { id: Math.random().toString(36).substr(2, 9), text: newBenefit }]);
    setNewBenefit("");
  };

  const handleAddIngredient = () => {
    if (!newIngredient.trim()) return;
    setIngredients([...ingredients, { id: Math.random().toString(36).substr(2, 9), text: newIngredient }]);
    setNewIngredient("");
  };
